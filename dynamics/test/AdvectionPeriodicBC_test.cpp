...
TEST_CASE("Advection Periodic Boundary Conditions")
{
    ...
    std::array<std::array<double, 6>, 3> exact = // Exact values taken 26/06/2024
      { std::array<double, 6>({1.0338503986019776e+00,1.1451366598186583e+00,1.0681593193338459e+00,9.5252231195653614e-01,8.1458581892610615e-01,6.8950068528265651e-01}),
	std::array<double, 6>({8.7678853597311990e-01,8.2389349440313742e-01,5.8562737114004948e-01,4.0006113872450388e-01,2.8493698219799091e-01,2.0801424342840488e-01}),
	std::array<double, 6>({6.0231338733029061e-01,4.6967937778236674e-01,3.2769774426726950e-01,2.3427321065537998e-01,1.7038111756667601e-01,1.2487338791917807e-01})
      };
